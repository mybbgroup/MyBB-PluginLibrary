...
class PluginLibrary
{
     ...
     */
    public function settings($name, $title, $description, $list, $makelang = false)
    {
        global $db;
     ...
     */
    public function settings_delete($name, $greedy = false)
    {
        global $db;
     ...
     */
    public function templates($prefix, $title, $list)
    {
        global $db;
     ...
     */
    public function templates_delete($prefix, $greedy = false)
    {
        global $db;
     ...
     */
    public function _build_css($styles)
    {
        if (is_array($styles)) {
            $css = '';
     ...
     */
    public function _build_attachedto($attachedto)
    {
     ...
     *
     */
    public function _update_themes_stylesheets($stylesheet = false)
    {
        global $mybb;
     ...
     */
    public function stylesheet($name, $styles, $attachedto = '')
    {
        global $db;
     ...
     */
    public function stylesheet_delete($name, $greedy = false, $delete = true)
    {
        global $db;
     ...
     *
     */
    public function stylesheet_deactivate($name, $greedy = false)
    {
     ...
     */
    public function _cache_handler()
    {
        global $cache;
     ...
     */
    public function cache_read($name)
    {
        global $cache;
     ...
     */
    public function cache_update($name, $contents)
    {
        global $cache;
     ...
     */
    public function cache_delete($name, $greedy = false)
    {
        global $db, $cache;
     ...
     */
    public function _uncomment($comment, $code)
    {
        if (!strlen($code)) {
            return '';
        }
     ...
     */
    public function _zapcomment($comment, $code)
    {
     ...
     */
    public function _align($text, &$start, &$stop)
    {
     ...
     */
    public function _match($text, $search, &$start)
    {
        $stop = $start;
     ...
     */
    public function _dissect($text, &$edits)
    {
        $matches = array();
        ...
        foreach ($edits as &$edit) {
            ...
            while (($stop = $this->_match($text, $search, $start)) !== false) {
                ...
                if (isset($matches[$start])) {
                    ...
                    return false;
                } elseif (count($edit['matches']) > 1 && !$edit['multi']) {
     ...
     */
    public function _edit($text, &$edits, $ins = '/**/', $del = '/*/*')
    {
     ...
     * edit core
     */
    public function edit_core($name, $file, $edits = array(), $apply = false, &$debug = null)
    {
        $ins = "/* + PL:{$name} + */ ";
        $del = "/* - PL:{$name} - /* ";
     ...
     * url_append
     */
    public function url_append($url, $params, $sep = '&amp;', $encode = true)
    {
        if (strpos($url, '?') === false) {
            $separator = '?';
        } else {
     ...
     * xml_import
     */
    public function xml_import($xml, &$error = null)
    {
